...
int main(int argc, char **argv){
        ...
        struct hostent *sp;   /* holds IP address of server */
	...
	unsigned char tagv[32]={0xc5,0xf3,0x40,0x40,0x00,0x11,0x00,0x02,0x00,0x01,
        ...
        if (argc < 4) {
        //if (argc < 2) {
                fprintf (stderr, "Usage: %s (source IP) (dest IP) (port)\n", argv[0]);
        ...
        bcopy(sp->h_addr_list[0], (caddr_t)&myaddr.sin_addr.s_addr,sp->h_length);

     //myaddr.sin_addr.s_addr = inet_addr("10.255.255.3");
